...
import { FaArrowLeft, FaCamera, FaSave, FaUser, FaPhone, FaStore } from "react-icons/fa";
    ...
    <div className="max-w-4xl mx-auto p-4 md:p-6 animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      <div className="bg-white rounded-[2.5rem] shadow-2xl shadow-blue-900/10 border border-slate-100 overflow-hidden">
        ...
        <div className="bg-gradient-to-r from-slate-900 via-blue-900 to-blue-800 p-10 text-white text-center">
          <h1 className="text-3xl font-black tracking-tight">Seller Store Profile</h1>
          <p className="opacity-80 text-sm mt-1">Manage your professional business details</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="p-8 md:p-12 space-y-10">
          ...
          <div className="flex flex-col items-center">
            <div className="relative group">
              <div className="w-40 h-40 rounded-[2.5rem] overflow-hidden border-4 border-slate-50 shadow-xl bg-slate-100">
                <img
                  src={preview || "/default-store.png"}
            ...
            <p className="mt-4 text-[10px] text-blue-900 font-black uppercase tracking-[0.2em]">Update Store Logo</p>
          </div>
